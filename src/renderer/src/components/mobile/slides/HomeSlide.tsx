...
function OrcaLogo(): React.JSX.Element {
  return (
    <svg className="mp-orca-logo" viewBox="0 0 128 128" fill="currentColor" aria-hidden>
      <path d="M18 10h92L96 29H78v22l20 13-20 13v22h18l14 19H18l14-19h18V29H32L18 10Zm47 38v32l26-16-26-16Z" />
    </svg>
  )
}
