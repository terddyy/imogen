...
const ATOM_FEED_URL = 'https://github.com/terddyy/ImogenAI/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/terddyy/ImogenAI/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/terddyy\/ImogenAI\/releases\/tag\/([^"]+)"/g
