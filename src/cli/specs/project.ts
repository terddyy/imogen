...
export const PROJECT_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    examples: [
      'orca project setups',
      'orca project setups --project github:terddyy/ImogenAI',
  ...
  },
  {
    ...
    examples: [
      'orca project setup-existing-folder --project github:terddyy/ImogenAI --host local --path ~/imogen',
      'orca project setup-existing-folder --project github:terddyy/ImogenAI --host runtime:gpu --path /home/me/imogen --kind git --json'
    ]
  },
  {
    ...
    examples: [
      'orca project setup-clone --project github:terddyy/ImogenAI --host local --url https://github.com/terddyy/ImogenAI.git --destination ~/src',
      'orca project setup-clone --project github:terddyy/ImogenAI --host runtime:gpu --url https://github.com/terddyy/ImogenAI.git --destination /srv --json'
    ]
  },
  {
    ...
    examples: [
      'orca project setup-create --project github:terddyy/ImogenAI --host runtime:gpu --state setting-up --method provisioned --json'
    ]
  },
  {
    ...
    examples: [
      'orca project setup-update --setup github:terddyy/ImogenAI::gpu --display-name "GPU VM"',
      'orca project setup-update --setup github:terddyy/ImogenAI::gpu --path /srv/imogen --state ready --json'
    ]
  },
  {
    ...
    examples: ['orca project setup-delete --setup github:terddyy/ImogenAI::gpu --json']
  }
]
