...
export const HOURLY_RELEASE_REPO = 'terddyy/imogenai-hourly'
export const DAILY_RELEASE_REPO = 'terddyy/imogenai-daily'
export const ADHOC_RELEASE_REPO = 'terddyy/imogenai-adhoc'
export const MAIN_RELEASE_REPO = 'terddyy/ImogenAI'
