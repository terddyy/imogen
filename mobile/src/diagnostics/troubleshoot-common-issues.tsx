...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow ImogenAI.',
      'Windows: Defender Firewall → Allow app — enable ImogenAI for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'ImogenAI must be open on your desktop to accept connections.',
      'Try restarting ImogenAI — the companion server starts on launch.',
