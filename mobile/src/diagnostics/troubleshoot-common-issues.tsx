...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Imogen.',
      'Windows: Defender Firewall → Allow app — enable Imogen for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Imogen must be open on your desktop to accept connections.',
      'Try restarting Imogen — the companion server starts on launch.',
