...
export function ProtocolBlockScreen({ verdict }: Props) {
  ...
  const title = isMobileTooOld ? 'Update ImogenAI Mobile' : 'Update ImogenAI on your computer'
  const body = isMobileTooOld
    ? `This desktop needs a newer ImogenAI Mobile app. Update ImogenAI Mobile from ${mobileUpdateTarget.storeName}, then try this host again.`
    : 'This paired desktop app is too old for your current ImogenAI Mobile app. Update ImogenAI on your computer, then try this host again.'
  const recoveryNote =
